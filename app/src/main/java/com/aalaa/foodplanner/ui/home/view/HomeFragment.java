//package com.aalaa.foodplanner.ui.home;
//
...
//import com.aalaa.foodplanner.ui.categories.CategoryAdapter;
//import com.aalaa.foodplanner.ui.countries.CountryAdapter;
//import com.aalaa.foodplanner.ui.home.view.MealAdapter;
...
//    private TextView tvSeeAllCategories, tvSeeAllCountries;
...
////            Navigation.findNavController(requireView()).navigate(R.id.action_homeFragment_to_mealsListingFragment,
////                    bundle);
////        });
...
////        forYouAdapter = new MealAdapter(getContext(), new ArrayList<>(), meal -> {
////            Bundle bundle = new Bundle();
////            bundle.putSerializable("meal", meal);
////            Navigation.findNavController(requireView()).navigate(R.id.recipeDetailFragment, bundle);
////        });
...
//      //  forYouAdapter.setMeals(meals);
//    }
//
////    @Override
////    public void showMealOfTheDay(MealsItem meal) {
////        progressMealOfDay.setVisibility(View.GONE);
////        if (meal != null && mealOfDayCard != null) {
